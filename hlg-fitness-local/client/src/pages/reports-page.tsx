...
import { Loader2, Download, FileText, BarChart, Calendar, ShoppingBag, TrendingUp } from "lucide-react";
          ...
          <Card>
            ...
            <CardFooter className="justify-between">
              ...
              >
                ...
                {isGeneratingSales ? "Gerando..." : "Gerar PDF"}
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card>
            ...
            <CardFooter className="justify-between">
              ...
              >
                ...
                {isGeneratingInventory ? "Gerando..." : "Gerar PDF"}
              </Button>
            </CardFooter>
          </Card>
        </div>
